...
from openwisp_monitoring.db.backends.influxdb2.client import QueryResultSet
from openwisp_monitoring.monitoring.tests import TestMonitoringMixin
from .. import timeseries_db


@tag("timeseries_client")
class TestInfluxDB2Client(TestMonitoringMixin, TestCase):
    ...
    def test_validate_query_allowed(self):
        ...
        # Should not raise
        result = timeseries_db.validate_query(query)
    ...
    def test_validate_query_aggregate(self):
        ...
        for query in aggregate_queries:
            result = timeseries_db.validate_query(query)
            self.assertTrue(
                result, f"Query should be detected as aggregate: {query}"
            )
    ...
    def test_duration_to_seconds(self):
        ...
        for duration_str, expected_seconds in test_cases:
            result = timeseries_db._duration_to_seconds(duration_str)
    ...
    def test_timestamp_format_datetime(self):
        ...
        timestamp = timeseries_db._get_timestamp(dt)
    ...
    def test_timestamp_format_string(self):
        ...
        result = timeseries_db._get_timestamp(timestamp_str)
    ...
    def test_write_single_point(self, mock_write_api):
        ...
        timeseries_db._write_api = mock_instance
    ...
    def test_write_with_database_parameter_warning(self):
        ...
        with patch(
            ...
            with patch.object(timeseries_db, "_write_api"):
                timeseries_db.write(
                    name="test",
                    values={"value": 1},
    ...
    def test_delete_metric_data_all(self):
        ...
        with patch.object(timeseries_db, "_delete_api") as mock_delete_api:
    ...
    def test_delete_metric_data_by_key(self):
        ...
        with patch.object(timeseries_db, "_delete_api") as mock_delete_api:
            timeseries_db.delete_metric_data(key="cpu")
            mock_delete_api.delete.assert_called()
            call_args = mock_delete_api.delete.call_args
    ...
    def test_delete_metric_data_by_tags(self):
        ...
        with patch.object(timeseries_db, "_delete_api") as mock_delete_api:
            timeseries_db.delete_metric_data(tags={"host": "server1"})
            mock_delete_api.delete.assert_called()
            call_args = mock_delete_api.delete.call_args
            predicate = call_args[0][2]
    ...
    def test_get_list_retention_policies(self):
        ...
        with patch.object(timeseries_db.db, "buckets_api") as mock_buckets_api:
            mock_api = MagicMock()
